...
?>
    ...
    <main class="container-fluid">
        ...
        <div class="text-center novo_carousel">
            <button class="estilo_botao"><a href="salas_novo.php">Adicionar Nova Sala</a></button>
        </div>
                    ...
                    <?php foreach($salas as $s): ?>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <button onclick="remover(<?= $s['id']; ?>, 'salas_apagar.php')" class="estilo_botao">Apagar</button>
